            ...
            <div className='flex'>
              <div className=' mt-10'>
                ...
                <div className="flex-col mt-10">
                  {isEditing ? (
                    <>
                      <button className='btn w-72 bg-warning mr-6 mt-4' onClick={handleSubmit2}>Save Changes</button>
                      <button className='btn w-72 bg-error mt-4' onClick={handleCancelClick}>Cancel</button>
                    </>
                  ) : (
                    <>
                      <button className='btn w-72 bg-warning mr-6 mt-4' onClick={handleUpdateButtonClick}>Update Memory</button>
                      <button className="btn w-72 bg-error mt-4" onClick={handleSubmit1}>Delete Memory</button>
                    </>
                  )}
                </div>
              </div>
