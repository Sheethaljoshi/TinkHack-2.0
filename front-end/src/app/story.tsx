  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-base-100 shadow-xl rounded-2xl">
      <div className="text-2xl font-bold text-[#343232] m-3">Remember When?</div>
        ...
        alt="Generated Story"
        className="w-[600px] h-[300px] object-contain bg-base-300 shadow-inner p-2 rounded-lg mb-3"
      />
      <div className="h-32 w-full mt-4 overflow-y-auto p-2 bg-base-200 rounded-lg shadow-inner">
